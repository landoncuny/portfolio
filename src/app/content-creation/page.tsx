...
export default function ContentCreationPage() {
  ...
  return (
    <>
      <style jsx>{`
        /* ========================================
           CONTENT CREATION - EDITORIAL LAYOUT
           Magazine-style interleaved sections
           ======================================== */
        ...
        .hero-video-card:nth-child(1) {
          top: 20px;
          left: 40px;
          z-index: 3;
          transform: rotate(-2deg);
          animation: cardFadeIn 0.8s ease 0.6s both;
          transition: transform 0.5s cubic-bezier(0.23, 1, 0.32, 1), box-shadow 0.5s ease, z-index 0s;
        }

        .hero-video-card:nth-child(1):hover {
          transform: rotate(-12deg) translateX(-80px) translateY(-30px) scale(1.02) !important;
          box-shadow: 0 35px 70px -15px rgba(225, 29, 72, 0.35);
          z-index: 10;
        }
        ...
        .hero-video-card:nth-child(2) {
          ...
          animation: cardFadeIn 0.8s ease 0.75s both;
          transition: transform 0.5s cubic-bezier(0.23, 1, 0.32, 1), box-shadow 0.5s ease, z-index 0s;
        }

        .hero-video-card:nth-child(2):hover {
          transform: rotate(10deg) translateX(90px) translateY(-20px) scale(1.02) !important;
          box-shadow: 0 35px 70px -15px rgba(225, 29, 72, 0.35);
          z-index: 10;
        }
        ...
        .hero-video-card:nth-child(3) {
          ...
          z-index: 1;
          transform: rotate(-1deg);
          animation: cardFadeIn 0.8s ease 0.9s both;
          transition: transform 0.5s cubic-bezier(0.23, 1, 0.32, 1), box-shadow 0.5s ease, z-index 0s;
        }

        .hero-video-card:nth-child(3):hover {
          transform: rotate(-8deg) translateX(-70px) translateY(40px) scale(1.02) !important;
          box-shadow: 0 35px 70px -15px rgba(225, 29, 72, 0.35);
          z-index: 10;
        }
        ...
        .hero-video-card .video-thumbnail {
          position: relative;
          width: 100%;
          height: 380px;
          overflow: hidden;
        ...
        .hero-video-card .video-thumbnail img {
          width: 100%;
          height: 100%;
          object-fit: cover;
        }

        .hero-video-card .video-thumbnail::before {
          content: '';
          position: absolute;
          inset: 0;
        ...
        .hero-video-card .video-thumbnail::after {
          content: '';
          position: absolute;
          top: 50%;
          left: 50%;
        ...
        .hero-video-card .platform-badge {
          position: absolute;
          top: 12px;
          left: 12px;
        ...
        .viral-card-stat strong {
          font-family: var(--font-display);
          font-size: 2rem;
        }

        .viral-card-stat span {
          color: rgba(255,255,255,0.5);
          font-size: 0.9rem;
        }
        ...
        /* ========================================
           STRATEGY SECTION - MAGAZINE STYLE
           ======================================== */
        ...
        .strategy-header-text h2 {
          font-family: var(--font-display);
          font-size: clamp(3rem, 6vw, 5rem);
          line-height: 0.95;
        }

        .strategy-header-text h2 span {
          font-style: italic;
          color: var(--accent);
        }

        .strategy-header-desc {
          font-size: 1.1rem;
          color: var(--text-secondary);
          line-height: 1.8;
          max-width: 500px;
        ...
        .social-btn.tiktok:hover { border-color: #000; }
          ...
          <div className="hero-video-stack">
            <div className="hero-video-card">
              <div className="video-thumbnail">
                <Image src="/images/video-thumb-1.jpg" alt="Viral content preview" width={300} height={380} style={{ objectFit: 'cover', width: '100%', height: '100%' }} />
            ...
            <div className="hero-video-card">
              <div className="video-thumbnail">
                <Image src="/images/video-thumb-2.jpg" alt="Content creation" width={300} height={380} style={{ objectFit: 'cover', width: '100%', height: '100%' }} />
            ...
            <div className="hero-video-card">
              <div className="video-thumbnail">
                <Image src="/images/video-thumb-3.jpg" alt="Content journey" width={300} height={380} style={{ objectFit: 'cover', width: '100%', height: '100%' }} />
                <span className="platform-badge">Instagram</span>
                <span className="play-icon"></span>
              </div>
              <div className="video-card-stats">
        ...
        <div className="interleave-text">
          ...
          <div className="interleave-content">
            ...
            <p className="interleave-desc">
              What started as a passion for fashion evolved into a platform connecting with millions. Through consistent short-form content, I built LandonDresses as both a personal brand and content company&mdash;combining creativity, analytics, and authenticity.
            </p>
          </div>
        </div>
        <div className="interleave-media">
          <Image src="/images/content-hero.jpg" alt="Content creation journey" fill style={{ objectFit: 'cover' }} />
        </div>
      </section>
      ...
      <section className="interleave-section reverse">
        <div className="interleave-text">
          ...
          <div className="interleave-content">
            ...
            <p className="interleave-desc">
              Every piece of content is informed by analytics&mdash;understanding what resonates, when to post, and how to optimize for the algorithm. But data only gets you so far. The real magic happens when analytics meet authentic storytelling.
            </p>
          </div>
        </div>
        <div className="interleave-media">
          <Image src="/images/content-viral.jpg" alt="Data-driven content strategy" fill style={{ objectFit: 'cover' }} />
        </div>
      </section>
      ...
      <section className="strategy-section">
        <div className="strategy-header">
          ...
          <p className="strategy-header-desc">
            Virality isn&apos;t luck&mdash;it&apos;s a formula. Here&apos;s the playbook I&apos;ve refined through millions of views and countless iterations.
          </p>
        </div>
      ...
      <section className="interleave-section">
        <div className="interleave-text">
          ...
          <div className="interleave-content">
            ...
            <p className="interleave-desc">
              What started in my dorm room is now a revenue-generating content operation. Brand partnerships, affiliate marketing, and sponsored content have turned passion into profession&mdash;all while staying authentic to my audience.
            </p>
          </div>
        </div>
        <div className="interleave-media">
          <Image src="/images/content-journey.jpg" alt="Content business growth" fill style={{ objectFit: 'cover' }} />
        </div>
      </section>
      ...
      <section className="social-section">
        ...
        <div className="social-buttons">
          <a href="https://instagram.com/landondresses" target="_blank" rel="noopener" className="social-btn instagram">
          ...
          <a href="https://tiktok.com/@landondresses" target="_blank" rel="noopener" className="social-btn tiktok">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1-.1z"/></svg>
            TikTok
          </a>
          <a href="https://youtube.com/@landondresses" target="_blank" rel="noopener" className="social-btn youtube">
